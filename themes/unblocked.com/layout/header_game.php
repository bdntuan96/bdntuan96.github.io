                    ...
                    <div class="d-flex play-btn">
                        <div class="dropdown mx-1 py-1 share-wrap">
                            ...
                            <div class="share_position hide-share">
                                ...
                                <button title="open twitter" aria-label="twitter" class="share_btn" onclick=" window.open('https://twitter.com/share?text=<?php echo $game_name; ?>&url=<?php echo $url ?>', 'twitter-share-dialog', 'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0');return false">
