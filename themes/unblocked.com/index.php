...
echo \helper\themes::get_layout('game_item', array('post' => $post, 'slogan' => $slogan, 'title' => $title, 'enable_ads' => $enable_ads));
echo \helper\themes::get_layout('header/richtext_home', array('game' => $game)); //schema
